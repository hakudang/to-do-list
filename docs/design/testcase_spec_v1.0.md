...
|----|------------------|-------------------|------------------|------------|
| TC-01 | Thêm task hợp lệ | 1. Nhập nội dung task hợp lệ.<br>2. Nhấn Add hoặc Enter. | Task mới hiển thị trong danh sách. Trạng thái mặc định là active. Dữ liệu lưu vào LocalStorage. |FR-01, UC-01, BR-04 |
| TC-02 | VAL-01: Bỏ trống nội dung | 1. Để trống ô nhập liệu.<br>2. Nhấn Add. | Hệ thống không thêm task, giữ nguyên màn hình hiện tại. |BR-01, VAL-01 |
| TC-03 | VAL-02: Nội dung chỉ có khoảng trắng | 1. Nhập "   " (space) hoặc tab vào ô input.<br>2. Nhấn Add. | Hệ thống không tạo task, không cập nhật dữ liệu. |BR-03, VAL-02 |
| TC-04 | VAL-03: Nội dung quá dài | 1. Nhập nội dung > 120 ký tự.<br>2. Nhấn Add. | Hệ thống reject input, không tạo task (không tự động cắt chuỗi).| BR-02, VAL-03 |
...
| ID | Mục tiêu kiểm thử |Các bước thực hiện | Kết quả mong đợi | Tham chiếu |
|----|------------------|-------------------|------------------|------------|
| TC-05 | Sửa task hợp lệ | 1. Chọn task.<br>2. Nhập nội dung mới (<= 120 ký tự).<br>3. Xác nhận. | Nội dung task được cập nhật thành công và lưu lại. | UC-02, FR-03 |
| TC-06 | Hủy thao tác sửa | 1. Chọn task đang sửa.<br>2. Nhấn Hủy (hoặc click ra ngoài tùy UI). | Hệ thống không thay đổi dữ liệu cũ. | UC-02 (AF-01) |
| TC-07 | BR-05: Sửa task đã hoàn thành | 1. Chọn task có trạng thái done.<br>2. Chỉnh sửa nội dung và lưu. | Hệ thống vẫn cho phép sửa nội dung ngay cả khi task đã xong. | BR-05, UC-02 |
...
| ID | Mục tiêu kiểm thử |Các bước thực hiện | Kết quả mong đợi | Tham chiếu |
|----|------------------|-------------------|------------------|------------|
| TC-09 | Chuyển đổi trạng thái | 1. Click vào checkbox của task. | Trạng thái chuyển đổi linh hoạt giữa active ↔ done. | UC-04, BR-04 |
| TC-10 | Lọc danh sách | 1. Chọn các filter: All, Active, Done. | Hiển thị đúng các task tương ứng với trạng thái. | UC-05, FR-06 |
